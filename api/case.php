<?php
	...
	if (isset($_GET["cid"])) {
		...
		if ($result->num_rows > 0) {
			...
			$sql = "SELECT * FROM cases.names WHERE caseID = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
			...
			$sql = "SELECT * FROM cases.dob WHERE caseId = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
			...
			$sql = "SELECT * FROM cases.lka WHERE caseId = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
			...
			$sql = "SELECT * FROM cases.emails WHERE caseId = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
			...
			$sql = "SELECT * FROM cases.phones WHERE caseId = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
			...
			$sql = "SELECT * FROM cases.found WHERE caseId = '".$_GET["CID"]."';";
			$result = $conn->query($sql);
			if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
